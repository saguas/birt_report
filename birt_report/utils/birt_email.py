...
from birt_report.utils.file import write_StringIO_to_file, get_birt_path
...
def birt_save_email(data, file_name, output, reqId, sender):
	...
	birt_path = get_birt_path(for_all_sites)
	birt_path_intern = path_join("birt_sent_email", sender, reqId)
	outputPath = path_join(birt_path, birt_path_intern)
